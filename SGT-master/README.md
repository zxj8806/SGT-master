This repository includes the source code of "**Spiking Graph Transformer: Bridging Energy Efficiency and Graph Data Processing with Spiking Neural Networks**"
